...
urlpatterns = patterns('',
                       ...
                       # List artists: /myartists/artists.json
                      # url(r'^artists\.(?P<extension>(json|xml))$', ArtistList.as_view(),
                       #    name='artist_list_conneg'),
...
urlpatterns += patterns('',
                        ...
                        url(r'^api/artistreviews/(?P<pk>\d+)/$', APIArtistReviewDetail.as_view(),
                            name='artistreview-detail'),
                        )
